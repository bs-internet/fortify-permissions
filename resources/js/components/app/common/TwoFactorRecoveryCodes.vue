...
import AlertError from '@/components/app/common/AlertError.vue';
...
<template>
    <Card class="w-full">
        <CardHeader>
            ...
            <CardDescription>
                Kurtarma kodları, doğrulama cihazınızı kaybetmeniz durumunda hesabınıza yeniden erişmenizi sağlar.
                Bunları güvenli bir parola yöneticisinde saklayın.
            </CardDescription>
        </CardHeader>
        <CardContent>
            <div class="flex flex-col gap-3 select-none sm:flex-row sm:items-center sm:justify-between">
                <Button @click="toggleRecoveryCodesVisibility" class="w-fit">
                    ...
                    Kurtarma Kodlarını {{ isRecoveryCodesVisible ? 'Gizle' : 'Göster' }}
                </Button>
            ...
            <div :class="[
                ...
                <div v-else class="mt-3 space-y-3">
                    ...
                    <p class="text-xs text-muted-foreground select-none">
                        Her kurtarma kodu, hesabınıza erişmek için yalnızca bir kez kullanılabilir ve kullanıldıktan
                        sonra silinir. Daha fazla koda ihtiyacınız olursa,
                        yukarıdaki <span class="font-bold">Kodları Yenile</span> butonuna tıklayın.
                    </p>
                </div>
            </div>
        </CardContent>

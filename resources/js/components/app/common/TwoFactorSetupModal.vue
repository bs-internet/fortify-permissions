...
const modalConfig = computed<TwoFactorConfigContent>(() => {
    if (props.twoFactorEnabled) {
        return {
            ...
            description:
                'İki faktörlü doğrulama artık etkin. QR kodu tarayın veya kurulum anahtarını kimlik doğrulama uygulamanıza girin.',
            buttonText: 'Kapat',
        };
    }
    ...
    if (showVerificationStep.value) {
        return {
            ...
            description: 'Kimlik doğrulama uygulamanız tarafından sağlanan 6 haneli kodu girin',
            buttonText: 'Devam Et',
        };
    }
    ...
    return {
        ...
        description:
            'İki faktörlü doğrulamayı etkinleştirmeyi tamamlamak için QR kodu tarayın veya kurulum anahtarını doğrulama uygulamanıza girin',
        buttonText: 'Devam Et',
    };
});
                ...
                <template v-if="!showVerificationStep">
                    ...
                    <template v-else>
                        ...
                        <div class="relative flex w-full items-center justify-center">
                            ...
                            <span class="relative bg-card px-2 py-1">veya kurulum anahtarını manuel girin</span>
                        </div>

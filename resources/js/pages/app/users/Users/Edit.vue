...
import { ChevronLeft, Save, UserCog, Shield, CheckCircle2, Loader2 } from 'lucide-vue-next';
...
import { update as userUpdate } from '@/actions/App/Http/Controllers/Users/UserController';
                    ...
                    <div class="rounded-md border border-border bg-card p-6 shadow-none space-y-4">
                        ...
                        <div class="grid gap-4 sm:grid-cols-2">
                            ...
                            <div class="space-y-2">
                                ...
                                <Input id="email" v-model="form.email" type="email" class="shadow-none focus-visible:ring-1" />
                        ...
                        <div class="grid gap-4 sm:grid-cols-2">
                            <div class="space-y-2">
                                <Label for="password">
                                    Şifre
                                    <span class="text-xs text-muted-foreground">(boş bırakılırsa değişmez)</span>
                                </Label>
